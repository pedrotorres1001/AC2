...
void _int_(32) isr_uart2(void)
{
    ...
    if (IFS1bits.U2RXIF == 1)
    {
        ...
        // Altere a rotina de serviço à interrupção e faça as inicializações necessárias, de modo a que
        // o LED ligado ao porto RC14 da placa DETPIC32 acenda quando for recebido o carater 'T',
        // e que apague quando for recebido o caracter 't'.

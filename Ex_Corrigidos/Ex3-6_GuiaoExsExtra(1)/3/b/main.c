...
// Acrescente à resolução que fez em a) a geração de um segundo sinal PWM, na saída OC5,
// usando como referência o mesmo timer. Para este sinal, ao valor máximo da conversão A/D
// deve corresponder o duty-cycle 0% e ao valor mínimo deve corresponder o duty-cycle 100%.

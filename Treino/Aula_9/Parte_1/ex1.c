...
void init() {
    ...
    T3CONbits.TCKPS = 5; // 1:4 prescaler 
    PR3 = 6249; // Fout = 20MHz / (4 * (62499 + 1)) = 100 Hz
    ...
    AD1CON1bits.SSRC = 7;    // 1 sample will be converted and stored in buffer locations ADC1BUF0 
